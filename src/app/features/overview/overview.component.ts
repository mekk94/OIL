...
const VM_CARDS: VmCard[] = [
  { key: 'vision', titleKey: 'overview.vision.title', bodyKey: 'overview.vision.body', image: 'images/overview/vision.webp' },
  { key: 'mission', titleKey: 'overview.mission.title', bodyKey: 'overview.mission.body', image: 'images/overview/mission.webp' },
];
